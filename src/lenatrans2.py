...
#             max_position_embeddings=sum([embedding_projections[x][1] for x in transactions_cat_features])
...
#             inputs_embeds=encoded_feat_matrix, attention_mask=mask.to(device), position_ids=position_ids.to(device)
#         )
